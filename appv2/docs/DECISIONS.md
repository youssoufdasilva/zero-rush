...
### P001: Card Count for Easy Mode
**Options**: 4 cards vs 5 cards  
**Considerations**: 4! = 24 perms (trivial?), 5! = 120 perms (still approachable)  
**Status**: Needs A/B testing

### P002: Odd-Number Card Progression
**Options**: Current (5-6/7-8-10) vs odd-only (5-7-9-11)  
...
### P005: Framework Choice
**Options**: Next.js (App Router) vs Vite + React  
**Considerations**: Next.js has better PWA ecosystem, Vite is lighter  
**Status**: Likely Next.js (shadcn defaults to it)
